...
@ Start main osc
	...
	ldr r1,=0x00000601  @ MOSCEN + OSCOUNT=6
	str r1,[r0]
...
wait_MOSCS:
	...
	ldr r1,=0x00481C0E  @ MUL=0x48(72) PLLCOUNT=0x1C(28) DIV=0x0E(14)
	str r1,[r0]
...
@   stack is used to hold the key kernel registers
@   while the kernel is not active. This store size
@   is 16 bytes large. The stack pointer is offset
@   from this.
@
stack_init_1:
...
@ Kick into main code using interworking
	...
	ldr r5,=main
enter_main:                     @ This label keeps GDB sane  
        mov lr,pc
	bx  r5
